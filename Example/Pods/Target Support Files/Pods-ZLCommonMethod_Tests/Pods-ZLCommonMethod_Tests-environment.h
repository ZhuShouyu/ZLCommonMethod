...
// ZLCommonMethod
#define COCOAPODS_POD_AVAILABLE_ZLCommonMethod
#define COCOAPODS_VERSION_MAJOR_ZLCommonMethod 0
#define COCOAPODS_VERSION_MINOR_ZLCommonMethod 1
#define COCOAPODS_VERSION_PATCH_ZLCommonMethod 0
